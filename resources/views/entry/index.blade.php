...
<main>
	<form method="post" action="{{ route('entry.postEntry') }}">
			...
			<div class="item-container mood">
				...
				<div class="mood-icons">
					<label for="super-happy">
						<input type="radio" name="mood" class="super-happy" id="super-happy" value="0" />
					...
					<label for="happy">
						<input type="radio" name="mood" class="happy" id="happy" value="1" />
					...
					<label for="neutral">
						<input type="radio" name="mood" class="neutral" id="neutral" value="2" />
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="100%" height="100%" viewBox="0 0 24 24" class="mood__svg">
					...
					<label for="sad">
						<input type="radio" name="mood" class="sad" id="sad" value="3" />
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="100%" height="100%" viewBox="0 0 24 24" class="mood__svg">
					...
					<label for="super-sad">
						<input type="radio" name="mood" class="super-sad" id="super-sad" value="4" />
						<svg viewBox="0 0 24 24" class="mood__svg">
		...
		<div class="item-container">
			<p class="container__p">What have you been doing today *</p>
			<input type="text" name="activity" id="activity" class="container__text-input" placeholder="Type here" value="{{ old('activity') }}">
		</div>
